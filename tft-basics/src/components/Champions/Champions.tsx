...
const champions: Champion[] = [
    ...
    {name: "Irelia", cost: Cost.Five, traits: ["Storyweaver", "Duelist"], ability: {name: "lade Dance", description: "Active: Command the blades to swiftly strike the three lowest Health enemies, dealing 100% AP + % AD and applying on-hit effects physical damage."}},
